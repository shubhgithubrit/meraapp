...
class PC7 extends StatelessWidget {
  final sg7 = Get.put(SM2());
  final gc7 = Get.put(MC2());
  PC7({Key? key}) : super(key: key);
  @override
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () {
                        gc7.addProductToCart(controller.pw[index]);
                      },
                    ),
                  );
                });
