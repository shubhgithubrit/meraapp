...
import 'package:meraapp/Get/c8.dart';
...
import 'package:meraapp/controller/mu3.dart';
import 'package:meraapp/controller/shop2.dart';

class PC8 extends StatelessWidget {
  final sg8 = Get.put(SM3());
  final gc8 = Get.put(MC3());
  PC8({Key? key}) : super(key: key);
  @override
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () {
                        gc8.addProductToCart(controller.pw[index]);
                      },
                    ),
                  );
                });
