...
class PC6 extends StatelessWidget {
  final sg6 = Get.put(SM1());
  final gc6 = Get.put(MC1());
  PC6({Key? key}) : super(key: key);
  @override
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    title: Text(
                      controller.pw[index].productName,
                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () {
                        gc6.addProductToCart(controller.pw[index]);
                      },
                    ),
                  );
                });
